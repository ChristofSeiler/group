...
|              |                                    |
|--------------|------------------------------------|
| [cellpaintr](https://github.com/christofseiler/cellpaintr/) | Analyze CRISPR and drug perturbations with CellProfiler features |
| [spillR](https://bioconductor.org/packages/spillR) | Nonparametric finite mixture model to compensate for spillover in mass cytometry data |
|[CytoGLMM](https://bioconductor.org/packages/CytoGLMM) | A bootstrapped generalized linear model for mass cytometry data |
| | |
|**Python**| |
